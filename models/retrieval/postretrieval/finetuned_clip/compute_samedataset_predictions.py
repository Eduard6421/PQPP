...
test_predictions_path = fr"./same_dataset_unprocessed_{selected_dataset}_predictions.pickle"
...
with open(fr"same_dataset_{selected_dataset}_clip_p10_predictions.pickle", "wb") as file:
    pickle.dump(clip_p10_predictions, file)

with open(fr"same_dataset_{selected_dataset}_clip_mrr_predictions.pickle", "wb") as file:
    pickle.dump(clip_mrr_predictions, file)	

with open(fr"same_dataset_{selected_dataset}_blip2_p10_predictions.pickle", "wb") as file:
    pickle.dump(blip2_p10_predictions, file)	

with open(fr"same_dataset_{selected_dataset}_blip2_mrr_predictions.pickle", "wb") as file:

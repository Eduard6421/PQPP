    ...
    for decay in hyperparameters["weight_decay"]:
        ...
        for epoch in range(num_epochs):
            ...
            if val_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), fr"./crossmodel_{train_source}_{selected_model}_best_model.pt")
...
model = NeuralNetworkRegressor().to(device)
model.load_state_dict(torch.load(fr"./crossmodel_{train_source}_{selected_model}_best_model.pt"))
model.eval()
...
pickle.dump(test_predictions, open(fr"./crossmodel_{train_source}_{selected_model}_test_predictions.pickle", "wb"))

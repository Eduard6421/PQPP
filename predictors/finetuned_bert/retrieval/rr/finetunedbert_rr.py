...
# fig.update_layout(
#     title='t-SNE visualization with Intensity Indicating Scores - Ground Truths',
...
# # Split the t-SNE results and scores by dataset
# train_tsne = embeddings_3d[:6000]
# val_tsne = embeddings_3d[6000:8000]
# test_tsne = embeddings_3d[8000:]
...
#         r,g,b = (255*score, 255*(1-score),0)
#         if score <= 0.5:
#             # Interpolate between green (0,255,0) and orange (255,165,0)
#             green_to_orange_factor = score * 2  # Scale factor to [0, 1] for this subrange
#             r = 255 * green_to_orange_factor
#             g = 255 - (90 * green_to_orange_factor)  # Decrease green, 165 = 255 - 90
#             b = 0
#         else:
...
# # Update layout for a better visualization
# fig.update_layout(
#     title='3D t-SNE visualization with Intensity Indicating Scores - Ground truth',
#     scene=dict(
#         xaxis_title='Component 1',
#         yaxis_title='Component 2',
...
#     height=900,
#     width=1600,
#     title='Density Contour of Predictions vs. Ground Truth - Finetuned Bert - MRR',
#     font=dict(size=25)
# )
...
# fig = px.box(df, x="ground_truth", y="prediction", title='Boxplot of Predictions and Ground Truth - Finetuned Bert - MRR', height=600)
# #plt.xlabel('Type')
# #plt.ylabel('Values')
...
# fig.show()
# pio.write_image(fig, 'boxplit_finetuned_bert_mrr.pdf')

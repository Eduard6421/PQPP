...
gt_all_p10_scores = "../../../../retrieval_models/avg_scores_p10_new.pickle"
with open(gt_all_p10_scores, "rb") as f:
    gt_all_p10_scores = pickle.load(f)
parsed_scores = []
for i in range(10000):
    parsed_scores.append(gt_all_p10_scores[i])
        ...
        for wd in hyperparameters["weight_decay"]:
            ...
            for epoch in range(epochs):
                ...
                if val_loss < best_val_loss:
                    ...
                    torch.save(model.state_dict(), "best_model_p10.pth")
                    print(
...
model.load_state_dict(torch.load("best_model_p10.pth"))
model.eval()
predictions = []
with torch.no_grad():
...
with open("test_predictions_p10.pickle", "wb") as f:
